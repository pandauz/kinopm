...
/*
Bu PHP Kodni hech qayerini o'zgartirmang.
Ushbu kod @MultiKoinot kanali admini @Strongest0305 ga tegishli.
ZIP ichidagi PHP larni qanday host ulashni admindan bilib olishingiz mumkin.
 */

/*	MULTIKOINOT	*/
function jdate($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){

 $T_sec=0;/* Bu kodni hech qayeriga tegmang */
